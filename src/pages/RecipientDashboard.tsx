    ...
    <div className="min-h-screen bg-surface">
      ...
      <main className="container py-10">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
          <div>
            <span className="text-xs font-bold tracking-[0.2em] text-primary uppercase">Cari Makanan</span>
          ...
          <Button variant="outline" size="lg" className="relative">
            ...
            <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-accent text-[10px] font-bold text-accent-foreground">3</span>
          </Button>
        </div>
        ...
        <div className="mt-8 relative overflow-hidden rounded-3xl border border-border shadow-soft h-64 md:h-80">
          ...
          <div className="absolute bottom-4 left-4 flex items-center gap-3 rounded-full bg-background/95 backdrop-blur px-4 py-2 shadow-card text-xs font-medium">
            <span className="flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-primary" /> Gratis</span>
            <span className="flex items-center gap-1.5"><span className="h-2.5 w-2.5 rounded-full bg-accent" /> Diskon</span>
          </div>
        </div>
